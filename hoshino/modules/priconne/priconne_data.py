...
class _PriconneData:
    ...
    CHARA = {
        ...
        1002: ["优衣", "ユイ", "Yui", "种田", "普田", "由衣", "结衣", "ue", "↗↘↗↘","对不起"],
        1003: ["怜", "レイ", "Rei", "剑圣", "普怜", "伶"],
        1004: ["禊", "ミソギ", "Misogi", "未奏希", "炸弹", "炸弹人", "💣"],
        1005: ["茉莉", "マツリ", "Matsuri", "跳跳虎", "老虎", "虎", "🐅","马自立"],
        ...
        1036: ["镜华", "キョウカ", "Kyouka", "小仓唯", "xcw", "小苍唯", "8岁", "八岁", "喷水萝", "八岁喷水萝", "8岁喷水萝","喷水"],
        1037: ["智", "トモ", "Tomo", "卜毛"],
        ...
        1805: ["可可萝(公主)","コッコロ（プリンセス）","公主妈","蝶妈","月光蝶"],
